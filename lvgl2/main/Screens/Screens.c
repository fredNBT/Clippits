...
static void buildPWMsgBox(char *SSIDText)
{
    ...
    lv_obj_add_event_cb(mboxConnectBtn, ConnectWifiSTA_event_cb, LV_EVENT_CLICKED, &wifi_credentials);
    lv_obj_center(btnLabel);

    lv_obj_t *mboxCloseBtn = lv_btn_create(mboxConnect);
    lv_obj_add_event_cb(mboxCloseBtn, mboxCloseBtn_event_cb, LV_EVENT_CLICKED, NULL);
